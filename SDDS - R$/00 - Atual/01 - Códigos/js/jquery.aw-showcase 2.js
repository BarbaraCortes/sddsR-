	...
	jQuery.fn.awShowcase = function(options) {
		...
		if (options.thumbnails)
		{
			...
			if (options.thumbnails_position === 'outside-first' || options.thumbnails_position === 'outside-last')
			{
				...
				{
					/* outside & horizontal */
					jQuery(thumb_wrapper).find('.showcase-thumbnail').css('float', 'center');
			...
			else
			{
				...
				thumbnailVisibleStretch += (getElementWidth(buttonBackward)) + (getElementWidth(buttonForward))+(getElementWidth(buttonBackward));
			...
			else
			{
				...
				thumb_restriction.css('width',  showcase_width-1.2*buttonsWidth);
			}
